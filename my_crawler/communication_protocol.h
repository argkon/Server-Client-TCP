...
ssize_t readCommandFromSocketBB(int fd, void * buf,size_t nbyte);

ssize_t readResponseFromSocketBB(int fd, void * buf,size_t nbyte);
...
ssize_t writeChunkToFileC(int fd, const void * buf, size_t nbyte);

ssize_t writeFileFromSocketC(int source, int destination, void * buf, size_t buffersize, size_t filesize);
